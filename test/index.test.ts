...
test("isOneOf", () => {
  ...
  expect(isOneOf(isString, isNumber, isBoolean, isArray)(undefined)).toEqual(
    false,
  );

  expect(
    isOneOf(isString, isNumber, isBoolean, isArray, isPlainObject)("_"),
  ).toEqual(true);
  expect(
    isOneOf(isString, isNumber, isBoolean, isArray, isPlainObject)(1),
  ).toEqual(true);
  expect(
    isOneOf(isString, isNumber, isBoolean, isArray, isPlainObject)(true),
  ).toEqual(true);
  expect(
    isOneOf(isString, isNumber, isBoolean, isArray, isPlainObject)([]),
  ).toEqual(true);
  expect(
    isOneOf(isString, isNumber, isBoolean, isArray, isPlainObject)({}),
  ).toEqual(true);
  expect(
    isOneOf(isString, isNumber, isBoolean, isArray, isPlainObject)(undefined),
  ).toEqual(false);
});
